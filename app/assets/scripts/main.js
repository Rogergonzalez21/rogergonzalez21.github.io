...
$(document).ready(function() {
    ...
    $.post({
      ...
      .done(function(data) {
        ...
        setTimeout(function() {
          swal(
            "Great",
            "Your email was sent. I will contact you soon. Thank you",
            "success"
          );
        }, 500);
      })
  ...
  $("#go-to-email").click(function() {
    ...
    sweetAlert({
      title: "Write Me",
      text:
        "You can write me though the Contact form. You will be on the form when this message closes (it will close automatically).",
      timer: 7000,
